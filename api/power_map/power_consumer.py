...
class PowerConsumer(
        PowerItemBase,
        GeometryPolygon,
        PowerConsumerPropertiesWithStats,
        ):
    _PropertiesModel = PowerConsumerPropertiesWithStats
    _PropertiesStyledModel = PowerConsumerPropertiesWithStatsStyled
    ...
    def feature_properties(self, context: Optional[Any] = None) -> PowerConsumerPropertiesWithStats:
