...
from typing import Any, Callable, Iterable, Optional, Self, TypeVar, Generic, Union
...
class GeoObject(BaseModel, Generic[Geom, ShapelyGeometryT, StyleT]):
    ...
    def geometry_type(cls):
        return cls.__pydantic_fields__['geometry'].annotation.__args__
...
class GeometryPoint(GeoObject[Point, ShapelyPoint, PointStyle]):
    pass
